...
-- ShapeNet Self Supervised  Texture Masked Conditional Adversarial Occupancy to Colored Voxels with Colored Voxels Experiment
local cmd = string.format('gpu=%d name=%s_selfsupervisedocc2colormaskedcondadvheadsvoxels disp=%d synset=%s th synthetic/maskedSelfSuperviseTextureColorShapenetVoxels.lua',params.gpu,params.class, params.disp, synset)
-- print(cmd)
