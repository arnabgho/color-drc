...
----print(encoder)
encoder = netBlocks.ImageOccupancyEncoder(3,1,64,params.bottleneckSize,true)
encoder:add(nn.Reshape(params.bottleneckSize,1,1,true))
encoder:apply(netInit.weightsInit)
---------------------------------
----------World Decoder----------
...
decoder:add(netBlocks.convDecoderSimple3dHeads(params.nConvDecLayers,nOutChannels,params.nConvEncChannelsInit,params.nVoxelChannels,params.nOccChannels,true,true,true,params.lambda_tv))
...
local fx = function(x)
    ...
    netRecons:forward({voxelsOcc,imgs})
    ...
    netRecons:backward({voxelsOcc,imgs}, { gradColor , gradPred})
    tm:stop()
