...
class ShapenetRenderer():
    ...
    def _initModelInfo(self):
        ...
        self.synsets =  ['03001627']  #['03001627','02691156','02958343']
        self.synsetModels = [[osp.join(self.config['shapenetDir'],s,f,'model_normalized.obj') for f in os.listdir(osp.join(self.config['shapenetDir'],s)) if len(f) > 3] for s in self.synsets]
